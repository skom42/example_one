...
class AppRouterDelegate extends RouterDelegate<RouteConfiguration>
  ...
  final GlobalKey<State<DashboardScreen>> navigationTabKey = GlobalKey<State<DashboardScreen>>();

  DashboardScreen get navigationTabState => navigationTabKey.currentState as DashboardScreen;
